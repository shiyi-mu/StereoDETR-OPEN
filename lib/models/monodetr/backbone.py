...
class BackboneBase(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, train_backbone: bool, return_interm_layers: bool, backbone_name):
        super().__init__()
...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
        ...
        assert name not in ('resnet18'), "number of channels are hard coded"
        backbone_name = name
        super().__init__(backbone, train_backbone, return_interm_layers, backbone_name)
        if dilation:
