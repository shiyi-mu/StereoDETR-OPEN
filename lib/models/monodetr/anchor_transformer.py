...
class AnchorTransformer(nn.Module):
    ...
    def forward(self, srcs, masks):
        ...
        mask = masks.repeat(1,l,1,1).reshape(bs*l,h,w)
        ...
        for lid, layer in enumerate(self.decoder_layers):
            ...
            inter_references_out.append(reference_points)

        return output, init_reference_out, inter_references_out, None, None, None
...
def build_anchor_transformer_stereo(cfg):
